...
# DDK ext module configs (graphics-kernel)
    "CONFIG_QCOM_KGSL": "m",
    ...
    "CONFIG_OPLUS_GPU_MINIDUMP": "y",
# DDK ext module configs (camera-kernel)
